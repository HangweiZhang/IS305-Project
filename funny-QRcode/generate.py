...
def run(words, version=5, level='H', picture=None, colorized=False, contrast=1.0, brightness=1.0, save_name=None, save_dir=None):
    ...
    def combine(ver, qr_name, bg_name, colorized, contrast, brightness, save_dir, save_name=None):
        from libs.constant import alig_location
    ...
    try:
        ...
        ver, qr_name = theqrmodule.get_qrcode(version, level, words, tempdir) # get qr code
...
# test in terminal
# run("words", version=5, picture="C:\\Users\\dell\\Pictures\\ACG\\lzn5 (2).jpg", colorized=True)